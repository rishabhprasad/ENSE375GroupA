pipeline {
    ...
    stages {
        ...
        stage('Test'){
            steps{
                sh 'cd lib/ ls'
                sh 'cd ENSE375/src/test/java/com/uregina/ ; java -jar ./lib/junit-platform-console-standalone-1.7.0-all.jar -cp "." --select-class AppTest.java PatientHistogramTest.java PatientListTest.java PatientTest.java PostalCodeTest.java RiskCodeMapTest.java SampleTest.java --reports-dir="reports"'
